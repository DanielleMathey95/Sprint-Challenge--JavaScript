...
const universities = graduates.map(function (grad) {
...
zooAnimals.map((animals) => {
  lowCaseAnimalNames.push(animals.animal_name.toLowerCase())
})
...
const population = zooAnimals.reduce(function(totalAnimals, item) {
